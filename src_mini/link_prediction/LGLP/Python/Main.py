...
print('seed: {}'.format(cmd_args.seed))
...
model_class = BaseNet if args.baseline else Net
classifier = model_class(cmd_args.feat_dim, cmd_args.hidden, cmd_args.latent_dim, cmd_args.dropout)
